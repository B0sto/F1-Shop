...
const Footer = () => {
    return (
        <footer className="border-t border-white/30 px-6 pt-3 pb-8 font-akshar text-white sm:px-8 sm:pt-16 sm:pb-14 lg:px-12 lg:pt-20 lg:pb-16 xl:px-16 2xl:px-36">
            <div className="w-full">
                <div className="grid gap-5 text-center md:grid-cols-2 md:text-left lg:gap-16 xl:grid-cols-[1.15fr_0.9fr_0.9fr_1.35fr]">
                    ...
                    <section>
                        ...
                        <form className="mx-auto mt-4 flex w-full max-w-60 flex-col gap-2 sm:mt-6 sm:max-w-100.25 sm:flex-row sm:gap-0 md:mx-0">
                            <input
                                type="email"
                                aria-label="Email"
                                placeholder="EMAIL"
