...
const RegisterScreen = () => {
    ...
    return (
        <div
            ...
            <form
                className="w-full max-w-120 rounded-xl bg-[#110D0D] px-7 py-10 font-akshar sm:px-12 sm:py-12 md:px-17.75 lg:px-19.5"
                ...
                <div className="flex flex-col gap-y-2.5 mb-4.75 relative">
                ...
                <button
                    className="mb-7 min-h-10 w-full cursor-pointer rounded-lg bg-[#F90301] py-1.5 text-[16px] text-white transition-all duration-300 hover:bg-[#aa0303]"
                    type="submit" disabled={isSubmitting}>{isSubmitting ? "Loading..." : "REGISTER"}</button>
                ...
                <button type="button"
                        className="flex min-h-11 w-full cursor-pointer items-center justify-center gap-x-2.5 border border-white pb-3 pt-2.25 transition-all duration-300 hover:bg-[#373737]">
                    <GoogleIcon/>
